...
`servicos/criador-de-catalogos`. Harnesses: `tests/paridade/fila.mts` (puro, strip-types) e
`tests/paridade/recuperacao.cts` (ts-node de `servicos/criador-de-catalogos`). Marcador `paridade`.
"""
import json
import subprocess
