...
| `python3 -m bim_pipeline.cli.ferramentas.ajuda_builder [--ajuda <dir> --indexar] <regex>` | Busca na ajuda em HTML do Builder — a única fonte que diz **o que um campo significa**. Indexa ~2.500 páginas uma vez num JSONL e busca sobre o texto; o diretório da ajuda é uma instalação do Builder, não do repositório |
