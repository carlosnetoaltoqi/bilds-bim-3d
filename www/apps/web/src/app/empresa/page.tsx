...
/**
 * /empresa — empresas cadastradas e seus catálogos, com as chamadas para ver,
 * editar e importar. Sem login (A7 de docs/arquitetura-www-servico-de-ingestao.md).
 */
      ...
      <div className="max-w-[880px] mx-auto">
        ...
        <div className="flex items-baseline justify-between gap-4 flex-wrap mb-6">
          ...
          <div className="flex gap-2">
            <a href="/empresa/importar" className="px-3 py-1.5 rounded bg-[#1e40af] text-white text-[12px] font-semibold">Importar biblioteca .aq</a>
            <a href="/importar-step" className="px-3 py-1.5 rounded border border-gray-300 text-[12px] font-semibold text-gray-700">Importar peça STEP / IFC</a>
        ...
        {empresas.map((e) => (
          <section key={e.id} className="bg-white border border-gray-200 rounded-lg mb-5">
            <header className="flex items-center gap-3 px-5 py-3 border-b border-gray-100">
              ...
              <a href={`/empresa/importar?empresa=${encodeURIComponent(e.customUrl)}`} className="text-[12px] text-[#1e40af] hover:underline">importar para esta empresa →</a>
            </header>
