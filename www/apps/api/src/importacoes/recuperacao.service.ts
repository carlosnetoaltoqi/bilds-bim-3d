/**
 * recuperacao.service.ts — o que fazer no boot com o que a queda da API deixou (I11).
 *
 ...
 * (o parse-worker tem 5 min de timeout e o Python 30 min).
 */
...
/** Uploads que o multer deixa em `os.tmpdir()`: `bim-<uuid>.aq` (importacoes) e `cad-<uuid>.<ext>` (step). */
export const UPLOAD_TEMPORARIO = /^(bim-[0-9a-f-]{36}\.aq|cad-[0-9a-f-]{36}\.(stp|step|ifc|ifczip|ifcxml))$/i;
