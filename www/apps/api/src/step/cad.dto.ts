...
import { IsSpecs, LIMITES } from '../common/validation';
...
/**
 * Campos de formulário do `POST /cad/importar` e `/cad/tesselar` (multipart — tudo chega
 * como texto; `deflexao` vira número). O arquivo é o `@UploadedFile()`.
 */
export class ImportarCadDto {
  @IsOptional()
  @Type(() => Number)
