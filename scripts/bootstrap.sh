...
# ── Opcionais ─────────────────────────────────────────────────────────────────
if [ -d web/node_modules/three ] && [ -d pacotes/base/node_modules ]; then linha ok "workspace (pnpm install)" "dependências presentes" "ls web/node_modules/three pacotes/base/node_modules"
