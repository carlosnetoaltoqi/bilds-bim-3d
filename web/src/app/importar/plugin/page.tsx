...
export default function ImportarPluginPage() {
  ...
  function enviar(e: FormEvent) {
    ...
    xhr.open('POST', `${CRIADOR_URL}/importacoes/plugin-autocad`)
    xhr.onerror = () => { setErro(`falha de rede ao enviar — o criador de catálogos está de pé em ${CRIADOR_URL}?`); setEnviando(false) }
    xhr.onload = () => {
      let corpo: any = {}
